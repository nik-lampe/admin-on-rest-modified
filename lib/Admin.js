...
var _reduxFormFixMiddleware = require('./reducer/reduxFormFixMiddleware');

var _reduxFormFixMiddleware2 = _interopRequireDefault(_reduxFormFixMiddleware);
...
var Admin = function Admin(_ref) {
    ...
    var store = (0, _redux.createStore)(resettableAppReducer, initialState, (0, _redux.compose)((0, _redux.applyMiddleware)(sagaMiddleware, (0, _reactRouterRedux.routerMiddleware)(routerHistory), _reduxFormFixMiddleware2.default), typeof window !== 'undefined' && window.devToolsExtension ? window.devToolsExtension() : function (f) {
        return f;
    }));
